"""
Main HelloSynk Class - Core orchestrator for the AI agent system
"""
...
from hellosynk.core.llm import LLMClient, LLMProvider, LLMMessage
from hellosynk.skills import SkillRegistry, BaseSkill


class HelloSynk:
    """Main HelloSynk agent class"""
    ...
    async def initialize(self):
        """Initialize HelloSynk (load memory, skills, etc.)"""
        if self.initialized:
            return
