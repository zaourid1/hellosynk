...
class SkillRegistry:
    """Registry for managing MindAI skills"""
    
    def __init__(self, skills_dir: Optional[Path] = None):
        if skills_dir is None:
            # Default to user's skills directory
            skills_dir = Path.home() / ".mindai" / "skills"
    ...
    def _load_builtin_skills(self):
        ...
        try:
            import mindai.skills as skills_package
            ...
            if skills_path and skills_path.exists():
                ...
                for _, name, _ in pkgutil.iter_modules([str(skills_path)]):
                    ...
                    try:
                        module = importlib.import_module(f"mindai.skills.{name}")
